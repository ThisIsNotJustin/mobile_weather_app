...
import { View, Text, Button, TouchableOpacity, StyleSheet, ImageBackground, Dimensions } from 'react-native';
...
export default function WelcomeScreen() {
  ...
  return (
    <ScreenLayout testID="welcome-screen">
      <ImageBackground 
        source={require('src/assets/images/welcome_background.jpeg')} 
